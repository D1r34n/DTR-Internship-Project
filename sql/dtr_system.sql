-- ========================================================
-- MERGED SQL DUMP
-- Source A: dump 1 (older schema, more log/overtime data)
-- Source B: dump 2 (newer schema with extra log columns)
-- Strategy: use dump 2 table structures; union all data
-- ========================================================
...
ALTER TABLE `departments` MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
ALTER TABLE `departments`
...
ALTER TABLE `employees` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
ALTER TABLE `employees`
...
-- --------------------------------------------------------
-- Table: cutoffs (union of both dumps)
-- --------------------------------------------------------
...
ALTER TABLE `cutoffs` ADD PRIMARY KEY (`id`);
ALTER TABLE `cutoffs` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

-- --------------------------------------------------------
-- Table: events (union of both dumps — all unique ids)
-- --------------------------------------------------------
CREATE TABLE `events` (
  `id` int(11) NOT NULL,
...
-- --------------------------------------------------------
-- Table: leave_requests (union of both dumps)
-- --------------------------------------------------------
...
ALTER TABLE `leave_requests` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
ALTER TABLE `leave_requests`
  ADD CONSTRAINT `leave_requests_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);

-- --------------------------------------------------------
-- Table: overtime_requests (union — dump 1 has id=19 not in dump 2)
-- --------------------------------------------------------
...
ALTER TABLE `overtime_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `employee_id` (`employee_id`);
ALTER TABLE `overtime_requests` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
ALTER TABLE `overtime_requests`
  ADD CONSTRAINT `overtime_requests_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`);

-- --------------------------------------------------------
-- Table: logs (dump 2 schema + all rows from both dumps)
-- --------------------------------------------------------
CREATE TABLE `logs` (
...
-- Rows from dump 1 (no edit columns — NULLs for new columns)
INSERT INTO `logs` (`id`, `employee_id`, `log_type`, `log_time`, `longitude`, `latitude`, `accuracy`, `is_within_office`, `distance_meters`, `photo_path`, `created_at`, `original_log_time`, `proposed_log_time`, `edit_status`, `edit_reason`, `edit_requested_by`) VALUES
(828, 22, 'IN',        '2026-05-12 07:21:00', 120.9955124, 14.5842482, 55, 1, 22.2953,  'cap_22_20260512_162137.jpg', '2026-05-12 08:21:37', NULL, NULL, NULL, NULL, NULL),
(829, 22, 'BREAK_IN',  '2026-05-12 12:00:00', 120.9954947, 14.5842564, 55, 1, 22.68,    NULL,                         '2026-05-12 08:21:49', NULL, NULL, NULL, NULL, NULL),
(830, 22, 'BREAK_OUT', '2026-05-12 13:07:00', 120.9954947, 14.5842564, 55, 1, 22.68,    NULL,                         '2026-05-12 08:21:57', NULL, NULL, NULL, NULL, NULL),
(831, 22, 'OUT',       '2026-05-12 18:22:00', 120.9954947, 14.5842564, 55, 1, 22.6814,  'cap_22_20260512_162205.jpg', '2026-05-12 08:22:05', NULL, NULL, NULL, NULL, NULL),
(832, 3,  'IN',        '2026-05-14 17:28:58', 120.9777000, 14.4470000, 20000, 0, 15401.3,'cap_3_20260514_172858.jpg',  '2026-05-14 09:28:58', NULL, NULL, NULL, NULL, NULL),
(833, 3,  'BREAK_IN',  '2026-05-14 17:29:11', 120.9777000, 14.4470000, 20000, 0, 15401.3,NULL,                        '2026-05-14 09:29:11', NULL, NULL, NULL, NULL, NULL),
(834, 3,  'BREAK_OUT', '2026-05-14 17:29:19', 120.9777000, 14.4470000, 20000, 0, 15401.3,NULL,                        '2026-05-14 09:29:19', NULL, NULL, NULL, NULL, NULL),
(835, 3,  'OUT',       '2026-05-14 17:29:27', 120.9777000, 14.4470000, 20000, 0, 15401.3,'cap_3_20260514_172927.jpg', '2026-05-14 09:29:27', NULL, NULL, NULL, NULL, NULL),
(839, 22, 'IN',        '2026-05-19 10:21:59', 120.9954955, 14.5842598, 55, 1, 22.3334,  'cap_22_20260519_102159.jpg', '2026-05-19 02:21:59', NULL, NULL, NULL, NULL, NULL),
(840, 22, 'OUT',       '2026-05-19 20:00:00', 120.9954906, 14.5842627, 55, 1, 22.4192,  'cap_22_20260519_135733.jpg', '2026-05-19 05:57:33', NULL, NULL, NULL, NULL, NULL),
(841, 22, 'IN',        '2026-05-20 09:21:06', 120.9955099, 14.5842550, 55, 1, 21.8204,  'cap_22_20260520_092106.jpg', '2026-05-20 01:21:06', NULL, NULL, NULL, NULL, NULL),
(842, 22, 'OUT',       '2026-05-20 17:30:00', 120.9955066, 14.5842572, 55, 1, 21.8326,  'cap_22_20260520_092128.jpg', '2026-05-20 01:21:28', NULL, NULL, NULL, NULL, NULL),
(847, 22, 'IN',        '2026-05-21 09:00:00', 120.9955054, 14.5842591, 55, 1, 21.7368,  'cap_22_20260521_093501.jpg', '2026-05-21 01:35:01', NULL, NULL, NULL, NULL, NULL),
(848, 22, 'OUT',       '2026-05-21 20:00:00', 120.9955005, 14.5842534, 55, 1, 22.5565,  'cap_22_20260521_094019.jpg', '2026-05-21 01:40:19', NULL, NULL, NULL, NULL, NULL),
(849, 20, 'IN',        '2026-05-20 13:50:08', 120.9955088, 14.5842496, 55, 1, 22.3849,  'cap_20_20260520_135008.jpg', '2026-05-20 05:50:08', NULL, NULL, NULL, NULL, NULL),
(850, 20, 'BREAK_IN',  '2026-05-20 13:50:13', 120.9955088, 14.5842496, 55, 1, 22.38,    NULL,                         '2026-05-20 05:50:13', NULL, NULL, NULL, NULL, NULL),
(851, 20, 'BREAK_OUT', '2026-05-20 13:50:22', 120.9955088, 14.5842496, 55, 1, 22.38,    NULL,                         '2026-05-20 05:50:22', NULL, NULL, NULL, NULL, NULL),
(852, 20, 'OUT',       '2026-05-20 13:50:27', 120.9955088, 14.5842496, 55, 1, 22.3849,  'cap_20_20260520_135027.jpg', '2026-05-20 05:50:27', NULL, NULL, NULL, NULL, NULL),
(857, 20, 'IN',        '2026-05-22 08:30:00', 120.9954791, 14.5842707, 55, 1, 22.5997,  'cap_20_20260522_111215.jpg', '2026-05-22 03:12:15', NULL, NULL, NULL, NULL, NULL),
(858, 20, 'OUT',       '2026-05-22 11:28:41', 120.9955018, 14.5842564, 55, 1, 22.2095,  'cap_20_20260522_112841.jpg', '2026-05-22 03:28:41', NULL, NULL, NULL, NULL, NULL),
(861, 19, 'IN',        '2026-05-22 15:12:15', 120.9954925, 14.5842611, 55, 1, 22.4298,  'cap_19_20260522_151215.jpg', '2026-05-22 07:12:15', NULL, NULL, NULL, NULL, NULL),
(862, 22, 'IN',        '2026-05-22 08:00:00', 120.9954891, 14.5842634, 55, 1, 22.4659,  'cap_22_20260522_154256.jpg', '2026-05-22 07:42:56', NULL, NULL, NULL, NULL, NULL),
(865, 22, 'OUT',       '2026-05-22 18:00:00', 120.9955029, 14.5842555, 55, 1, 22.2247,  'cap_22_20260522_160011.jpg', '2026-05-22 08:00:11', NULL, NULL, NULL, NULL, NULL),
-- Rows from dump 2 (have edit columns populated)
(891, 19, 'IN',        '2026-05-25 08:30:00', 120.9954976, 14.5842557, 55, 1, 22.5421,  'cap_19_20260525_095149.jpg', '2026-05-25 01:51:49', '2026-05-25 09:51:49', '2026-05-25 08:30:00', 'approved', 'No reason provided', 39),
(892, 39, 'IN',        '2026-05-25 07:23:00', 120.9954913, 14.5842607, 55, 1, 22.5357,  NULL,                         '2026-05-25 02:23:29', '2026-05-25 10:23:29', '2026-05-25 07:23:00', 'approved', 'No reason provided', 39);

ALTER TABLE `logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_employee_time` (`employee_id`, `log_time`),
  ADD KEY `idx_log_type` (`log_type`);
ALTER TABLE `logs` MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=893;

-- --------------------------------------------------------
-- Table: log_edit_requests (only in dump 1)
-- --------------------------------------------------------
...
ALTER TABLE `log_edit_requests` MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
ALTER TABLE `log_edit_requests`
  ADD CONSTRAINT `log_edit_requests_ibfk_1` FOREIGN KEY (`log_id`) REFERENCES `logs` (`id`);

-- --------------------------------------------------------
-- Table: schedules (dump 1 schema — fuller; union of all rows)
-- --------------------------------------------------------
...
-- Rows from dump 2 (ids 532-577, extra columns NULL)
...
-- Rows from dump 1 only (ids 479, 490-495, 502, 510-524 — not present in dump 2)
INSERT INTO `schedules` (`id`, `employee_id`, `requested_by`, `schedule_date`, `scheduled_start`, `scheduled_end`, `is_rest_day`, `status`, `pending_delete`, `updated_at`, `is_archived`, `request_type`, `batch_id`, `orig_is_rest_day`, `orig_scheduled_start`, `orig_scheduled_end`) VALUES
...
ALTER TABLE `schedules` MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=578;

-- --------------------------------------------------------
-- Table: attendances (union of both dumps — no overlapping ids)
-- --------------------------------------------------------
...
-- Rows from dump 2 (ids 404-449, no overlap with dump 1)
INSERT INTO `attendances` (`id`, `employee_id`, `schedule_id`, `work_date`, `scheduled_start`, `scheduled_end`, `actual_time_in`, `actual_time_out`, `total_work_minutes`, `late_minutes`, `undertime_minutes`, `overtime_minutes`, `break_minutes`, `status`, `overtime_status`, `missed_time_out`, `created_at`, `updated_at`) VALUES
...
-- Note: dump 2 id=405 conflicts with dump 1 id=405 (different data).
-- Dump 1 id=405 (employee 20, schedule 502, 2026-05-23) is kept above.
-- Dump 2 id=405 (employee 20, schedule 533, 2026-05-02) inserted here with a safe id.
INSERT INTO `attendances` (`id`, `employee_id`, `schedule_id`, `work_date`, `scheduled_start`, `scheduled_end`, `actual_time_in`, `actual_time_out`, `total_work_minutes`, `late_minutes`, `undertime_minutes`, `overtime_minutes`, `break_minutes`, `status`, `overtime_status`, `missed_time_out`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `password_setup_tokens`
  ...
  ADD KEY `employee_id` (`employee_id`);
ALTER TABLE `password_setup_tokens` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `quote_of_the_day` ADD PRIMARY KEY (`id`);
...
ALTER TABLE `system_state` ADD PRIMARY KEY (`key_name`);
