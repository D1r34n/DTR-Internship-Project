  ...
  function sendMessage() {
    ...
    fetch(getApiPath(), {
      ...
      .then(text => {
        ...
        if (reply === "[redirect_about]") {
          addMessage("bot", "Opening About page...");
          window.location.href = (window.location.pathname.includes("/admin/") ? "about.php" : "admin/about.php");
          return;
        }
