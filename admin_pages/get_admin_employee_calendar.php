...
foreach ($schedMap as $date => $sched) {
    if ($sched['is_rest_day'] || !$sched['scheduled_start'] || !$sched['scheduled_end']) {
        continue;
    }
...
foreach ($allDates as $dateStr) {
    ...
    // rejected leave/OB still show schedule info
