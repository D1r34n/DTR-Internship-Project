...
>>>>>>> 0c2065d8b18a856b63b872791a6ed9c094bf5ec6
?>
...
<<<<<<< HEAD
  ...
  <body>
    <div class="navBar">
        <a href=""><img src="images/HSN.png" alt="DTR Logo" class="logo"></a>
        <div class="navGreetings">
            <a><img src="images/user_profile.svg" alt="User Icon" class="userIcon"></a>
            <h4>Welcome, <?php echo htmlspecialchars($email); ?>!</h4>
        </div>
    </div>
